...
<head>
    ...
    <title>Tabella delle Cose</title>
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <form method="post" action="paginaita.php?action=logout">
    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                // Query per recuperare i dati dalla tabella 'cose'
                $query = "SELECT * FROM `italiano`";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='4'>Nessun dato trovato nella tabella 'cose'</td></tr>";
                }
